...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">
        <a href="{{ url('/admin/coverage/'.$coverage->state_id.'/cities') }}" class="nav-link"><i class="fas fa-shipping-fast"></i> {{ $coverage->getState->name }}</a>
    </li>
    <li class="breadcrumb-item">
        <a href="{{ url('/admin/coverage/city/'.$coverage->id.'/edit') }}" class="nav-link"><i class="fas fa-shipping-fast"></i> {{ $coverage->name }}</a>
    </li>
@endsection
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="panel shadow">
                ...
                <div class="header">
                    <h2 class="title"><i class="fas fa-edit"></i> Editar Municipio Para Envios</h2>
                </div>
                ...
                <div class="inside">
                    @if(kvfj(Auth::user()->permissions, 'coverage_edit'))
                        {!! Form::open(['url' => '/admin/coverage/city/'.$coverage->id.'/edit']) !!}
                            ...
                            <div class="input-group">
                                <span class="input-group-text" id="basic-addon1"><i class="fas fa-keyboard"></i></span>
                                {!! Form::number('shipping_value', $coverage->price , ['class'=>'form-control', 'min' => '1', 'step' => 'any']) !!}
                            </div>
        ...
        <div class="col-md-4">
            <div class="panel shadow">
                ...
                <div class="inside">
                    @if($coverage->ctype == "1")
                        <p><strong>Tipo de Cobertura: </strong> Municipio </p>
